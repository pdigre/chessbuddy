var Chessground = (function () {
  ...
  var t = e(function (e, t) {
    ...
    o = e(function (e, o) {
      Object.defineProperty(o, '__esModule', { value: !0 }),
        (o.computeSquareCenter =
          ...
          o.invRanks =
            void 0),
        (o.invRanks = [...t.ranks].reverse()),
        (o.allKeys = Array.prototype.concat(...t.files.map(e => t.ranks.map(t => e + t))));
      ...
      const n = (e, t, o, n) => [(t ? e[0] : 7 - e[0]) * o, (t ? 7 - e[1] : e[1]) * n];
      ...
      (o.createEl = (e, t) => {
        ...
        (o.computeSquareCenter = function (e, t, n) {
          const r = o.key2pos(e);
          return (
    ...
    n = e(function (e, t) {
      ...
      (t.queen = (e, t, o, n) => r(e, t, o, n) || s(e, t, o, n)),
        (t.premove = function (e, i, a) {
                ...
                : (function (e, t, o) {
                    return (r, s, i, a) =>
                      ...
                      (o &&
                        s === a &&
                        s === ('white' === e ? 0 : 7) &&
                        ((4 === r && ((2 === i && t.includes(0)) || (6 === i && t.includes(7)))) ||
                          t.includes(i)));
                  })(
                    c.color,
                    (function (e, t) {
                      const n = 'white' === t ? '1' : '8',
                        r = [];
                      for (const [s, i] of e)
                        s[1] === n && i.color === t && 'rook' === i.role && r.push(o.key2pos(s)[0]);
                      return r;
                    })(e, c.color),
                    a
                  );
          var p;
          return o.allPos
            .filter(e => (l[0] !== e[0] || l[1] !== e[1]) && u(l[0], l[1], e[0], e[1]))
            .map(o.pos2key);
        });
    }),
    r = e(function (e, t) {
      ...
      function s(e) {
        e.premovable.current && ((e.premovable.current = void 0), r(e.premovable.events.unset));
      }
      function i(e) {
      ...
      function a(e, t, n) {
        ...
        return (
          ...
          (function (e, t, n) {
            ...
            4 !== s[0] ||
              e.pieces.has(n) ||
              (6 === i[0] ? (n = o.pos2key([7, i[1]])) : 2 === i[0] && (n = o.pos2key([0, i[1]])));
            ...
            return !(
              ...
              e.pieces.delete(n),
              s[0] < i[0]
                ? (e.pieces.set(o.pos2key([6, i[1]]), r), e.pieces.set(o.pos2key([5, i[1]]), a))
                : (e.pieces.set(o.pos2key([2, i[1]]), r), e.pieces.set(o.pos2key([3, i[1]]), a)),
              0)
            );
      ...
      function d(e, t, o) {
        if (g(e, t, o)) {
          ...
          if (n) {
            ...
            return !0 !== n && (i.captured = n), r(e.movable.events.after, t, o, i), !0;
          }
        } else if (
          (function (e, t, o) {
            return t !== o && v(e, t) && n.premove(e.pieces, t, e.premovable.castle).includes(o);
          })(e, t, o)
        )
          return (
            (function (e, t, o, n) {
              i(e), (e.premovable.current = [t, o]), r(e.premovable.events.set, t, o, n);
      ...
      function f(e, t) {
        ...
        return (
          !!o &&
          ('both' === e.movable.color || (e.movable.color === o.color && e.turnColor === o.color))
        );
      }
      function g(e, t, o) {
        var n, r;
        return (
          ...
          f(e, t) &&
          (e.movable.free ||
            !!(null === (r = null === (n = e.movable.dests) || void 0 === n ? void 0 : n.get(t)) ||
            void 0 === r
              ? void 0
              : r.includes(o)))
        );
      ...
      function v(e, t) {
        const o = e.pieces.get(t);
        return (
          !!o && e.premovable.enabled && e.movable.color === o.color && e.turnColor !== o.color
        );
      }
      function m(e) {
        s(e), i(e), p(e);
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (t.setCheck = function (e, t) {
          if (((e.check = void 0), !0 === t && (t = e.turnColor), t))
            for (const [o, n] of e.pieces) 'king' === n.role && n.color === t && (e.check = o);
        }),
        (t.unsetPremove = s),
        (t.unsetPredrop = i),
        (t.baseMove = a),
        ...
        (t.dropNewPiece = function (e, t, o, n) {
          ...
          ((function (e, t, o) {
            ...
            ? (e.pieces.delete(t),
              c(e, a, o, n),
              r(e.movable.events.afterNewPiece, a.role, o, { premove: !1, predrop: !1 }))
            : a &&
              (function (e, t, o) {
                const n = e.pieces.get(t),
                  r = e.pieces.get(o);
        ...
        (t.selectSquare = function (e, t, o) {
          if ((r(e.events.select, t), e.selected)) {
            if (e.selected === t && !e.draggable.enabled) return p(e), void e.hold.cancel();
        ...
        (t.isDraggable = function (e, t) {
          ...
          return (
            ...
            e.draggable.enabled &&
            ('both' === e.movable.color ||
              (e.movable.color === o.color && (e.turnColor === o.color || e.premovable.enabled)))
          );
        }),
        (t.playPremove = function (e) {
          ...
          if (g(e, o, n)) {
            ...
            if (t) {
              const s = { premove: !0 };
              !0 !== t && (s.captured = t), r(e.movable.events.after, o, n, s), (i = !0);
            }
          }
          return s(e), i;
        }),
        (t.playPredrop = function (e, t) {
          ...
          if (t(o)) {
            c(e, { role: o.role, color: e.movable.color }, o.key) &&
              (r(e.movable.events.afterNewPiece, o.role, o.key, { premove: !1, predrop: !0 }),
              (n = !0));
          }
          return i(e), n;
        }),
        (t.cancelMove = m),
        (t.stop = function (e) {
          (e.movable.color = e.movable.dests = e.animation.current = void 0), m(e);
        }),
        (t.getKeyAtDomPos = function (e, t, n) {
          let r = Math.floor((8 * (e[0] - n.left)) / n.width);
          t || (r = 7 - r);
          let s = 7 - Math.floor((8 * (e[1] - n.top)) / n.height);
          return t || (s = 7 - s), r >= 0 && r < 8 && s >= 0 && s < 8 ? o.pos2key([r, s]) : void 0;
        }),
        (t.getSnappedKeyAtDomPos = function (e, t, r, s) {
          const i = o.key2pos(e),
            a = o.allPos.filter(
              e => n.queen(i[0], i[1], e[0], e[1]) || n.knight(i[0], i[1], e[0], e[1])
            ),
            c = a.map(e => o.computeSquareCenter(o.pos2key(e), r, s)).map(e => o.distanceSq(t, e)),
            [, l] = c.reduce((e, t, o) => (e[0] < t ? e : [t, o]), [c[0], 0]);
          return o.pos2key(a[l]);
        }),
    ...
    s = e(function (e, n) {
      ...
      const r = { p: 'pawn', r: 'rook', n: 'knight', b: 'bishop', q: 'queen', k: 'king' },
        s = { pawn: 'p', rook: 'r', knight: 'n', bishop: 'b', queen: 'q', king: 'k' };
      (n.read = function (e) {
        'start' === e && (e = n.initial);
        const t = new Map();
        let s = 7,
          ...
          switch (n) {
            ...
            default:
              ...
              if (a < 57) i += a - 48;
                ...
                t.set(o.pos2key([i, s]), { role: r[e], color: n === e ? 'black' : 'white' }), ++i;
              }
          }
        return t;
      }),
        ...
        (t.configure = function (e, t) {
          ...
          if (
            ((null === (n = t.movable) || void 0 === n ? void 0 : n.dests) &&
              (e.movable.dests = void 0),
            (function e(t, n) {
              for (const r in n) o(t[r]) && o(n[r]) ? e(t[r], n[r]) : (t[r] = n[r]);
            })(e, t),
    ...
    a = e(function (e, t) {
      ...
      function s(e, t) {
        return t.sort((t, n) => o.distanceSq(e.pos, t.pos) - o.distanceSq(e.pos, n.pos))[0];
      }
      Object.defineProperty(t, '__esModule', { value: !0 }),
                  ...
                  a = (function (e, t) {
                    ...
                    for (const s of o.allKeys)
                      (u = t.pieces.get(s)),
                        ...
                        u
                          ? p
                            ? o.samePiece(u, p.piece) || (c.push(p), l.push(r(s, u)))
                            : l.push(r(s, u))
                          : p && c.push(p);
                    for (const r of l)
                      (p = s(
                        ...
                        p &&
                          ...
                          i.push(p.key));
                    for (const o of c) i.includes(o.key) || a.set(o.key, o.piece);
                  ...
                  (t.animation.current = {
                    ...
                    e ||
                      (function e(t, o) {
                        ...
                        if (void 0 === n) return void (t.dom.destroyed || t.dom.redrawNow());
                        const r = 1 - (o - n.start) * n.frequency;
                        if (r <= 0) (t.animation.current = void 0), t.dom.redrawNow();
                        else {
                          const o =
                            (s = r) < 0.5 ? 4 * s * s * s : (s - 1) * (2 * s - 2) * (2 * s - 2) + 1;
    ...
    c = e(function (e, t) {
        ...
        requestAnimationFrame(() => {
          ...
          if (t) {
            ...
            const n = t.snapToValidMove
              ? r.getSnappedKeyAtDomPos(t.orig, t.pos, r.whitePov(e), e.dom.bounds())
              : o;
            n !== t.mouseSq &&
              ((t.mouseSq = n), (t.dest = n !== t.orig ? n : void 0), e.dom.redrawNow()),
              s(e);
          }
        });
      }
      ...
      function a(e) {
        ...
        const r = (e.shiftKey || e.ctrlKey) && o.isRightButton(e),
          s =
            e.altKey ||
            e.metaKey ||
            (null === (t = e.getModifierState) || void 0 === t ? void 0 : t.call(e, 'AltGraph'));
      ...
      (t.start = function (e, t) {
        ...
        t.stopPropagation(), t.preventDefault(), t.ctrlKey ? r.unselect(e) : r.cancelMove(e);
        ...
        (t.cancel = i),
        (t.clear = function (e) {
          e.drawable.shapes.length && ((e.drawable.shapes = []), e.dom.redraw(), c(e.drawable));
        });
    }),
    l = e(function (e, t) {
      function n(e) {
        requestAnimationFrame(() => {
          ...
          if (i && o.samePiece(i, r.piece)) {
            if (
              (!r.started &&
                o.distanceSq(r.pos, r.origPos) >= Math.pow(e.draggable.distance, 2) &&
                (r.started = !0),
              r.started)
            ) {
              if ('function' == typeof r.element) {
                const e = r.element();
                if (!e) return;
                (e.cgDragging = !0), e.classList.add('dragging'), (r.element = e);
              }
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (t.start = function (e, t) {
          ...
          const s = e.dom.bounds(),
            i = o.eventPosition(t),
            d = r.getKeyAtDomPos(i, r.whitePov(e), s);
          if (!d) return;
          const u = e.pieces.get(d),
            p = e.selected;
          p ||
            !e.drawable.enabled ||
            (!e.drawable.eraseOnClick && u && u.color === e.turnColor) ||
            c.clear(e),
            !1 === t.cancelable ||
              (t.touches &&
                e.movable.color &&
                ...
                !(function (e, t) {
                  ...
                  for (const r in e.pieces) {
                    const e = o.computeSquareCenter(r, n, s);
          ...
          (e.stats.ctrlKey = t.ctrlKey),
            e.selected && r.canMove(e, e.selected, d)
              ? a.anim(e => r.selectSquare(e, d), e)
              : r.selectSquare(e, d);
          const v = e.selected === d,
            m = l(e, d);
          if (u && m && v && r.isDraggable(e, d)) {
            (e.draggable.current = {
              orig: d,
              piece: u,
              origPos: i,
            ...
            a &&
              ((a.className = `ghost ${u.color} ${u.role}`),
              o.translateAbs(a, o.posToTranslateAbs(s)(o.key2pos(d), r.whitePov(e))),
              o.setVisible(a, !0)),
              n(e);
          } else f && r.unsetPremove(e), g && r.unsetPredrop(e);
          e.dom.redraw();
        }),
        (t.dragNewPiece = function (e, t, r, s) {
          const i = 'a0';
          e.pieces.set(i, t), e.dom.redraw();
          const a = o.eventPosition(r);
          (e.draggable.current = {
            orig: i,
            piece: t,
            origPos: a,
        ...
        (t.end = function (e, t) {
          ...
          a && n.started && n.orig !== a
            ? n.newPiece
              ...
              : ((e.stats.ctrlKey = t.ctrlKey), r.userMove(e, n.orig, a) && (e.stats.dragged = !0))
            : n.newPiece
            ? e.pieces.delete(n.orig)
            : e.draggable.deleteOnDropOff &&
              !a &&
              (e.pieces.delete(n.orig), r.callUserFunction(e.events.change)),
            ((n.orig !== n.previouslySelected || (n.orig !== a && a)) && e.selectable.enabled) ||
              r.unselect(e),
            i(e),
            (e.draggable.current = void 0),
            e.dom.redraw();
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (t.start = function (e, t) {
          ...
          return {
            ...
            getKeyAtDomPos: t => r.getKeyAtDomPos(t, r.whitePov(e), e.dom.bounds()),
            redrawAll: t,
            dragNewPiece(t, o, n) {
        ...
        (t.defaults = function () {
          return {
            ...
            drawable: {
              ...
              pieces: { baseUrl: 'https://lichess1.org/assets/piece/cburnett/' },
              prevSvgHash: '',
            },
            hold: o.timer(),
          };
    ...
    f = e(function (e, t) {
      ...
      function r({ orig: e, dest: t, brush: o, piece: n, modifiers: r }, i, a, c) {
        return [
          c.width,
          c.height,
          a,
      ...
      function i(e, { shape: t, current: r, hash: s }, i, a, g) {
        ...
        if (t.piece)
          ...
          })(e.drawable.pieces.baseUrl, l(o.key2pos(t.orig), e.orientation), t.piece, g);
        else {
          ...
          if (t.dest) {
            ...
            t.modifiers && (m = d(m, t.modifiers)),
              ...
              })(m, s, l(o.key2pos(t.dest), e.orientation), r, (a.get(t.dest) || 0) > 1, g));
          } else
            v = (function (e, t, o, r) {
              const s = f(t, r),
                i = (function (e) {
        ...
        (t.renderSvg = function (e, t) {
          ...
          !(function (e, t, o) {
            ...
            (function (e, t, o, n, r, s) {
              ...
              for (const p of t) c.get(p.hash) || r.appendChild(i(e, p, o, n, a));
            })(e, u, o.brushes, c, t, f);
        });
    }),
    g = e(function (e, n) {
      function r(e, t) {
        ...
        let r;
        for (const s of e) (r = o.createEl('coord')), (r.textContent = s), n.appendChild(r);
        return n;
      }
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.renderWrap = void 0),
        (n.renderWrap = function (e, n, s) {
          ...
          for (const o of t.colors) e.classList.toggle('orientation-' + o, n.orientation === o);
          ...
          if (
            ...
            a.appendChild(r(t.ranks, 'ranks' + e)), a.appendChild(r(t.files, 'files' + e));
          }
          return (
            n.draggable.showGhost &&
              !s &&
              ((d = o.createEl('piece', 'ghost')), o.setVisible(d, !1), a.appendChild(d)),
          ...
          const r = (function (e) {
            return t => {
              e.draggable.current
                ...
                : e.viewOnly || (e.dropmode.active ? v.drop(e, t) : l.start(e, t));
            };
          })(e);
        ...
        (t.bindDocument = function (e, t) {
          ...
          if (
            ...
            const t = r(e, l.move, c.move),
              s = r(e, l.end, c.end);
            for (const e of ['touchmove', 'mousemove']) o.push(n(document, e, t));
    ...
    h = e(function (e, t) {
      Object.defineProperty(t, '__esModule', { value: !0 }), (t.updateBounds = t.render = void 0);
      const n = o;
      function s(e) {
      ...
      (t.render = function (e) {
        const t = r.whitePov(e),
          p = e.dom.relative ? n.posToTranslateRel : n.posToTranslateAbs(e.dom.bounds()),
          ...
          y = (function (e) {
            ...
            if (e.selected && (d(o, e.selected, 'selected'), e.movable.showDests)) {
              const n = null === (t = e.movable.dests) || void 0 === t ? void 0 : t.get(e.selected);
              if (n) for (const t of n) d(o, t, 'move-dest' + (e.pieces.has(t) ? ' oc' : ''));
              const r = e.premovable.dests;
              if (r) for (const t of r) d(o, t, 'premove-dest' + (e.pieces.has(t) ? ' oc' : ''));
            }
            const n = e.premovable.current;
            if (n) for (const s of n) d(o, s, 'current-premove');
            else e.predroppable.current && d(o, e.predroppable.current.key, 'current-premove');
            const r = e.exploding;
        ...
        for (A = g.firstChild; A; ) {
          if (((S = A.cgKey), s(A)))
            if (
              ...
              !A.cgDragging ||
                (w && w.orig === S) ||
                (A.classList.remove('dragging'), f(A, p(o.key2pos(S), t)), (A.cgDragging = !1)),
              !q && A.cgFading && ((A.cgFading = !1), A.classList.remove('fading')),
              K)
            ) {
              if (D && A.cgAnimating && O === l(K)) {
                const e = o.key2pos(S);
                (e[0] += D[2]), (e[1] += D[3]), A.classList.add('anim'), f(A, p(e, t));
              } else
                A.cgAnimating &&
                  ((A.cgAnimating = !1),
        ...
        for (const [n, r] of v)
          if (((D = h.get(n)), !P.has(n)))
            if (((x = M.get(l(r))), (_ = x && x.pop()), _)) {
              (_.cgKey = n), _.cgFading && (_.classList.remove('fading'), (_.cgFading = !1));
              const r = o.key2pos(n);
              e.addPieceZIndex && (_.style.zIndex = c(r, t)),
                D &&
                  ((_.cgAnimating = !0), _.classList.add('anim'), (r[0] += D[2]), (r[1] += D[3])),
                f(_, p(r, t));
            } else {
              const s = l(r),
        ...
        (t.updateBounds = function (e) {
          ...
          for (; c; )
            ((s(c) && !c.cgAnimating) || i(c)) && n.translateAbs(c, a(o.key2pos(c.cgKey), t)),
              (c = c.nextSibling);
        });
    });
  return e(function (e, t) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      (t.Chessground = function (e, t) {
        ...
        return i.configure(r, t || {}), u.start(s(), s);
      });
  }).Chessground;
})();
