...
const winner_urls: EmotionType[] = [
  ...
  { src: '/mp4/win3.mp4', width: 700, height: 360, length: 11 }, // wider
  { src: '/mp4/win4.mp4', width: 540, height: 360, length: 3 },
];
const correct_urls: EmotionType[] = [
  { src: '/mp4/yes1.mp4', width: 700, height: 270, length: 1 }, // wider
...
const mistake_urls: EmotionType[] = [
  ...
  { src: '/mp4/no2.mp4', width: 638, height: 266, length: 1 }, // wider
